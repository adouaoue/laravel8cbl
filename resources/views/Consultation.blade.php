...
<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
    ...
    <th scope="col" class="px-6 py-3">
      <span class="sr-only">stauts</span>
      </th>
    </tr>
    </thead>
    <tbody> 
    ...
    <tr class="bg-gray-100 text-center border-b text-sm text-gray-600">
        ...
        <td>
            <a href="{{ url('approved',$c->id) }}" class="bg-green-500 p-2 text-white hover:shadow-lg text-xs font-thin">Accept</a>
            <a   href="{{ url('notapproved',$c->id) }}" class="bg-red-500 p-2 text-white hover:shadow-lg text-xs font-thin">Refuse</a>
