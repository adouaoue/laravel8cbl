    ...
    <div class="mt-5 md:mt-0 md:col-span-2">
      <form method="POST" action="{{route("add")}}">
        ...
        <div class="shadow overflow-hidden sm:rounded-md">
          <div>
            <h1 class="text-blue-600">Ajouter un Patient</h1>
          </div>          
         ...
         <div class="px-4 py-5 bg-white sm:p-6">
            <div class="grid grid-cols-6 gap-6">
              ...
              <div class="col-span-6 sm:col-span-4">
                ...
                <input type="text" name="date_naissance" class="mt-1 px-3 py-2 bg-white border shadow-sm border-slate-300 placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-sky-500 block w-full rounded-md sm:text-sm focus:ring-1" placeholder="Departement" />
              </div> 
                <div class="col-span-6 sm:col-span-3">
                <label for="spesialite" class="block text-sm font-medium text-gray-700">num_dossier</label>
                <select id="num_dossier" name="num_dossier" autocomplete="spesialite" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                  <option></option>
